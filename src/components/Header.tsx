  ...
  return (
    <header className="sticky top-0 z-40 w-full border-b border-[#D9D092] dark:border-slate-800/60 bg-[#EBE3A7]/95 dark:bg-[#090D14]/90 backdrop-blur-md transition-colors duration-300 shadow-sm">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
        ...
        >
          <div className="flex items-center justify-center w-9 h-9 rounded-xl bg-emerald-500/20 dark:bg-emerald-500/10 border border-emerald-700/40 dark:border-emerald-500/30 text-emerald-900 dark:text-emerald-400 group-hover:scale-105 transition-transform shadow-sm">
            <Shield className="w-5 h-5" />
          </div>
          <div>
            <span className="font-extrabold text-lg tracking-tight bg-gradient-to-r from-emerald-900 to-cyan-900 dark:from-emerald-400 dark:to-cyan-400 bg-clip-text text-transparent">
              CIVIC GUARD
            </span>
            <span className="text-[10px] font-extrabold text-[#334155] dark:text-slate-500 ml-1.5 font-mono">v2.5</span>
          </div>
        </div>

        {/* Center Minimal Twin Engine Switcher */}
        <div className="flex items-center p-1 rounded-xl bg-[#DCD396] dark:bg-[#131924] border border-[#C5BC7F] dark:border-slate-800/80 shadow-inner">
          <button
            onClick={() => setActiveRoute('SHOMADHAN')}
        ...
        <div className="flex items-center space-x-2">
          ...
          {/* Language Toggle */}
          <div className="flex items-center bg-[#DCD396] dark:bg-[#131924] rounded-lg p-0.5 border border-[#C5BC7F] dark:border-slate-800 text-[11px]">
            <button
          ...
          <button
            ...
            className="p-2 rounded-lg bg-[#DCD396] dark:bg-[#131924] border border-[#C5BC7F] dark:border-slate-800 text-[#0F172A] dark:text-slate-300 hover:text-emerald-900 transition-colors shadow-sm"
          >
